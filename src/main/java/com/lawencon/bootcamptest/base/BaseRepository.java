...
public abstract class BaseRepository{
    ...
    public <T extends BaseModel> T save(T entityClass) {
    	getConnection().persist(entityClass);
    	
    	return entityClass;
    }
    
    public <T extends BaseModel> T update(T entityClass) {
	...
	public <T extends BaseModel> T getById(Class<T> entityClass,String id) {
